...
from traffic_trainer.models.timesnet import create_timesnet_model
...
def load_config(config_path: Path) -> TimesNetTrainingConfig:
    ...
    return TimesNetTrainingConfig(
        ...
        wandb_run_name=logging_cfg.get("wandb_run_name", "timesnet-run"),
